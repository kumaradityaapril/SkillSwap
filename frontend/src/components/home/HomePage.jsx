  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="overflow-hidden relative py-24 text-white bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-600">
        ...
        <div className="absolute -right-24 -bottom-24 w-64 h-64 bg-white rounded-full opacity-10"></div>
        ...
        <div className="container relative z-10 px-4 mx-auto text-center">
          <h1 className="mb-6 text-4xl font-bold leading-tight md:text-6xl animate-fadeIn">
            Share Skills, <span className="text-blue-200">Grow Together</span>
          </h1>
      ...
      <section className="py-24 bg-white">
        <div className="container px-4 mx-auto">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-gray-600">Our platform makes it easy to connect, learn, and grow with just three simple steps</p>
          </div>
          
          <div className="grid gap-10 md:grid-cols-3">
            <div className="p-8 text-center bg-white rounded-2xl border border-gray-100 shadow-lg transition-all duration-300 transform hover:shadow-xl hover:-translate-y-2">
              ...
              <h3 className="mb-4 text-2xl font-bold text-gray-800">Create Your Profile</h3>
            ...
            <div className="p-8 text-center bg-white rounded-2xl border border-gray-100 shadow-lg transition-all duration-300 transform hover:shadow-xl hover:-translate-y-2">
              ...
              <h3 className="mb-4 text-2xl font-bold text-gray-800">Connect with Others</h3>
              <p className="leading-relaxed text-gray-600">
            ...
            <div className="p-8 text-center bg-white rounded-2xl border border-gray-100 shadow-lg transition-all duration-300 transform hover:shadow-xl hover:-translate-y-2">
              ...
              <h3 className="mb-4 text-2xl font-bold text-gray-800">Schedule Sessions</h3>
              <p className="leading-relaxed text-gray-600">
          ...
          <div className="mt-12 text-center">
            <Link to="/register" className="inline-flex items-center font-semibold text-blue-600 transition-colors hover:text-blue-800">
      ...
      <section className="py-24 bg-gray-50">
        <div className="container px-4 mx-auto">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">Featured Skills</h2>
            <div className="mx-auto mb-6 w-20 h-1 bg-blue-500 rounded-full"></div>
            <p className="mx-auto max-w-2xl text-lg text-gray-600">Discover popular skills taught by our community members</p>
          </div>
          
          <div className="grid gap-8 md:grid-cols-3">
            {/* Skill Card 1 */}
            <div className="overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:shadow-xl hover:-translate-y-2">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-3">
                  <span className="px-3 py-1 text-xs font-semibold text-blue-800 bg-blue-100 rounded-full">Technology</span>
                  <div className="flex items-center px-2 py-1 bg-gray-50 rounded-full">
                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
                    <span className="ml-1 text-sm font-medium text-gray-700">4.8</span>
                  </div>
                </div>
                <h3 className="mb-3 text-xl font-bold text-gray-800">Web Development</h3>
                <p className="mb-4 leading-relaxed text-gray-600">Learn modern web development techniques from experienced developers.</p>
                <div className="flex justify-between items-center pt-3 border-t border-gray-100">
                  <span className="flex items-center text-sm text-gray-500">
                    <Users className="mr-1 w-4 h-4" /> 120 learners
                  </span>
                  <Link to="/skills/web-development" className="flex items-center font-semibold text-blue-600 hover:text-blue-800">
            ...
            <div className="overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:shadow-xl hover:-translate-y-2">
              <div className="flex overflow-hidden relative justify-center items-center h-48 bg-gradient-to-r from-green-400 to-green-600">
                <div className="absolute inset-0 bg-green-600 opacity-20 pattern-dots"></div>
                <svg className="w-24 h-24 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-3">
                  <span className="px-3 py-1 text-xs font-semibold text-green-800 bg-green-100 rounded-full">Finance</span>
                  <div className="flex items-center px-2 py-1 bg-gray-50 rounded-full">
                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
                    <span className="ml-1 text-sm font-medium text-gray-700">4.6</span>
                  </div>
                </div>
                <h3 className="mb-3 text-xl font-bold text-gray-800">Financial Planning</h3>
                <p className="mb-4 leading-relaxed text-gray-600">Master the basics of personal finance and investment strategies.</p>
                <div className="flex justify-between items-center pt-3 border-t border-gray-100">
                  <span className="flex items-center text-sm text-gray-500">
                    <Users className="mr-1 w-4 h-4" /> 85 learners
                  </span>
                  <Link to="/skills/financial-planning" className="flex items-center font-semibold text-blue-600 hover:text-blue-800">
                    Learn more <ChevronRight className="ml-1 w-4 h-4" />
                  </Link>
                </div>
              </div>
            ...
            <div className="overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:shadow-xl hover:-translate-y-2">
              <div className="flex overflow-hidden relative justify-center items-center h-48 bg-gradient-to-r from-purple-400 to-purple-600">
                <div className="absolute inset-0 bg-purple-600 opacity-20 pattern-dots"></div>
                <svg className="w-24 h-24 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-3">
                  <span className="px-3 py-1 text-xs font-semibold text-purple-800 bg-purple-100 rounded-full">Language</span>
                  <div className="flex items-center px-2 py-1 bg-gray-50 rounded-full">
                    <Star className="w-4 h-4 text-yellow-500 fill-current" />
                    <span className="ml-1 text-sm font-medium text-gray-700">4.9</span>
                  </div>
                </div>
                <h3 className="mb-3 text-xl font-bold text-gray-800">Spanish Conversation</h3>
                <p className="mb-4 leading-relaxed text-gray-600">Practice Spanish with native speakers in a friendly environment.</p>
                <div className="flex justify-between items-center pt-3 border-t border-gray-100">
                  <span className="flex items-center text-sm text-gray-500">
                    <Users className="mr-1 w-4 h-4" /> 150 learners
                  </span>
                  <Link to="/skills/spanish-conversation" className="flex items-center font-semibold text-blue-600 hover:text-blue-800">
                    Learn more <ChevronRight className="ml-1 w-4 h-4" />
                  </Link>
                </div>
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="container px-4 mx-auto">
          <div className="mb-16 text-center">
            ...
            <div className="mx-auto mb-6 w-20 h-1 bg-blue-500 rounded-full"></div>
            <p className="mx-auto max-w-2xl text-lg text-gray-600">Hear from people who have transformed their skills through our platform</p>
          </div>
          
          <div className="grid gap-8 md:grid-cols-3">
            {/* Testimonial 1 */}
            <div className="relative p-8 bg-gray-50 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
              ...
              <div className="flex items-center mb-6">
                <img
                  ...
                  alt="User"
                  className="mr-4 w-16 h-16 rounded-full ring-4 ring-white shadow-md"
                />
                <div>
            ...
            <div className="relative p-8 bg-gray-50 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="font-medium text-blue-600">Marketing Specialist</p>
                </div>
              </div>
              <p className="mb-6 italic leading-relaxed text-gray-700">
            ...
            <div className="relative p-8 bg-gray-50 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl">
              ...
              <div className="flex items-center mb-6">
                ...
                />
                <div>
                  <h3 className="text-lg font-bold text-gray-900">Sophia Martinez</h3>
                  <p className="font-medium text-blue-600">Language Learner</p>
                </div>
              </div>
              <p className="mb-6 italic leading-relaxed text-gray-700">
